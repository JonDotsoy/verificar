import BaselineFace24pxComponent from "./icons/BaselineFace24px.component";
import BaselineStayPrimaryPortrait24pxComponent from "./icons/BaselineStayPrimaryPortrait24px.component";
import BaselineMailComponent from "./icons/BaselineMail.component";
import BaselineLocationOnComponent from "./icons/BaselineLocationOn.component";
import BaselineLocationCityComponent from "./icons/BaselineLocationCity.component";
import CarOfHatchbackComponent from "./icons/CarOfHatchback.component";
import FoldedNewspaperComponent from "./icons/FoldedNewspaper.component";
